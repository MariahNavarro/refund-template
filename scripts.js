// Seleciona os elemnetos do fórmulario
...
amount.oninput = () => {
    ...
    // Transforma o valor em centavos (exemplo: 150/100 que é equivalente a R$ 1,50).
...
function formatCurrencyBRL(value){
    // Formata o valor no padrão BRL (Real Brsileiro).
    value = value.toLocaleString("pt-BR", {
        style: "currency",
        currency: "BRL",
    })
    
    // Retorna ao valor formatado.
    return value
}
